...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function connect() {
      ...
      var elViewer = (0, _CreateElement["default"])('div', {
        id: 'bpmn-viewer'
      }, elContainer);
    ...
    value: function render() {
      this.viewer = new _NavigatedViewer["default"]({
        container: '#bpmn-viewer'
      });
      var controller = this;
      var diagram = this.diagramValue;
      controller.openDiagram(diagram);
    }
  }, {
    key: "openDiagram",
    value: function () {
      var _openDiagram = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(bpmnXML) {
        var canvas;
